...
const Selectors = Object.freeze({
  ...
  claude: {
    ...
    // [data-is-streaming] covers Claude's extended-thinking phase, when no
    // visible Stop button is rendered yet. Without it our "stop button gone"
    // signal fired prematurely during thinking and captured "Thinking…" as
    // the answer.
    stopButton: 'button[aria-label="Stop response"], button[aria-label="Stop generating"], [data-is-streaming]',
